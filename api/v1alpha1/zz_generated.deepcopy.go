...
func (in *ScwExternalIPStatus) DeepCopyInto(out *ScwExternalIPStatus) {
	*out = *in
	if in.AttachedIPs != nil {
		...
		*out = make([]ScwNodeExternalIP, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.DeletingIPs != nil {
		in, out := &in.DeletingIPs, &out.DeletingIPs
		*out = make([]ScwNodeExternalIP, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScwNodeExternalIP) DeepCopyInto(out *ScwNodeExternalIP) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScwNodeExternalIP.
func (in *ScwNodeExternalIP) DeepCopy() *ScwNodeExternalIP {
	if in == nil {
		return nil
	}
	out := new(ScwNodeExternalIP)
	in.DeepCopyInto(out)
	return out
}
